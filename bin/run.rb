...
while input_from_user != "q" || "Q"
  ...
  when "1"
    ...
    while input_from_user != "q" || "Q"
      ...
      puts "Press 4 to return recipes you can make."
      ...
      when "4"
        ...
        if recipes.length != 0#this means we found recipes
          ...
          while input != "q" || "Q"
            ...
            puts "Please enter the number of the recipe you would like to view or enter q to go back:"
            #recipe_number = gets.chomp
            input = gets.chomp
            if input == "q"
              break
            else
              recipe_number = input.to_i
          ...
          #THIS WILL BE USED WHEN WE ADD FUNCTIONALITY OF ALLOWING USER TO SAVE
          #RECIPES TO THEIR "PROFILE"
